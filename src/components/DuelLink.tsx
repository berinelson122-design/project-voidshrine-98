    ...
    <div className="p-4 bg-black border-2 border-[#E056FD] font-mono text-[10px] w-64 shadow-[0_0_20px_rgba(224,86,253,0.2)]">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className={`w-full py-2 flex items-center justify-center gap-2 font-black transition-all ${status === "ACTIVE" ? "bg-[#39ff14] text-black" : "bg-[#FF003C] text-white hover:bg-white hover:text-black"
            }`}
        >
          <Zap size={14} />
